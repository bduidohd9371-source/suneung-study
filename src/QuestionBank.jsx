...
function QuestionBank({ initialSubject, onExit, onStart }) {
  ...
  return (
    <main className="bank-shell">
      <header className="bank-header"><button className="button button-secondary" onClick={onExit}><ArrowLeft size={16} /> 공부방</button><div><span className="eyebrow">QUESTION BANK</span><h1>기본 문항 목록</h1></div></header>
